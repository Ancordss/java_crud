...
public class frm_estudiantes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_tel1.setText("genero");

        lbl_tel2.setText("email");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txt_carnet, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(6, 6, 6))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txt_genero, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(layout.createSequentialGroup()
    ...
    private void btb_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btb_agregarActionPerformed
      /*  cliente = new Cliente(txt_nit.getText(),txt_name.getText(),txt_ape.getText(),txt_dir.getText(),txt_tel.getText(),txt_fn.getText());
       /* cliente.setNit());
        ...
        cliente.agregar();
            // TODO add your handling code here:*/
        cliente = new Estudiante(0,txt_carnet.getText(),txt_name.getText(),txt_ape.getText(),txt_dir.getText(),txt_tel.getText(),txt_genero.getText(),txt_email.getText(),txt_fn.getText()); 
        cliente.agregar();
    ...
    private void selec_datos(){
        ...
        //txt_id.setText(tbl_cliente.getValueAt(fila,0).toString());
        ...
        txt_genero.setText(tbl_cliente.getValueAt(fila,6).toString());
        txt_email.setText(tbl_cliente.getValueAt(fila,7).toString());
        txt_fn.setText(tbl_cliente.getValueAt(fila,8).toString());
    ...
    private void btb_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btb_delActionPerformed
        // TODO add your handling code here:
        int op = JOptionPane.showConfirmDialog(null,"desea eliminar","mensaje",JOptionPane.YES_NO_OPTION);
        if (op == 0){
                 cliente = new Estudiante(0,txt_carnet.getText(),txt_name.getText(),txt_ape.getText(),txt_dir.getText(),txt_tel.getText(),txt_genero.getText(),txt_email.getText(),txt_fn.getText()); 
        cliente.eliminar();
        tbl_cliente.setModel(cliente.leer());
